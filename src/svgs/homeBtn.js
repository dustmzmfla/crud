    ...
    return (
        <SvgStyle>
            <svg width={props.width} height={props.height} viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M6 18.8887V12.8887C6 11.7841 6.89543 10.8887 8 10.8887H10C11.1046 10.8887 12 11.7841 12 12.8887V18.8887" stroke={props.color} stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </SvgStyle>
    )
}
